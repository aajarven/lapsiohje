...
% uuden scratchin kuvia
\newcommand{\hahmovalikko}{\ensuremath{%
  \mathchoice{\includegraphics[height=2ex]{kuvat/valitsehahmo.png}}
    {\includegraphics[height=2ex]{kuvat/valitsehahmo.png}}
    {\includegraphics[height=1.5ex]{kuvat/valitsehahmo.png}}
    {\includegraphics[height=1ex]{kuvat/valitsehahmo.png}}
}}

\newcommand{\taustavalikko}{\ensuremath{%
  \mathchoice{\includegraphics[height=2ex]{kuvat/valitsetausta.png}}
    {\includegraphics[height=2ex]{kuvat/valitsetausta.png}}
    {\includegraphics[height=1.5ex]{kuvat/valitsetausta.png}}
    {\includegraphics[height=1ex]{kuvat/valitsetausta.png}}
}}

\newcommand{\lataa}{\ensuremath{%
  \mathchoice{\includegraphics[height=2ex]{kuvat/lataa.png}}
    {\includegraphics[height=2ex]{kuvat/lataa.png}}
    {\includegraphics[height=1.5ex]{kuvat/lataa.png}}
    {\includegraphics[height=1ex]{kuvat/lataa.png}}
}}

\newcommand{\yllata}{\ensuremath{%
  \mathchoice{\includegraphics[height=2ex]{kuvat/yllata.png}}
    {\includegraphics[height=2ex]{kuvat/yllata.png}}
    {\includegraphics[height=1.5ex]{kuvat/yllata.png}}
    {\includegraphics[height=1ex]{kuvat/yllata.png}}
}}
...
\newcommand{\pysayta}{\ensuremath{%
  \mathchoice{\includegraphics[height=2ex]{kuvat/pysayta.png}}
    {\includegraphics[height=2ex]{kuvat/pysayta.png}}
    {\includegraphics[height=1.5ex]{kuvat/pysayta.png}}
    {\includegraphics[height=1ex]{kuvat/pysayta.png}}
}}
